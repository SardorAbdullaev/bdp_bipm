...
class Vgg16():
    ...
    def create(self):
        ...
        fname = 'vgg16.h5'
        model.load_weights("/home/sardor_antje_kristina/bdp_bipm/"+fname)
    ...
    def ft(self, num):
        ...
        #print("Prob layer = ",model.layers[-1])
    ...
    def fit(self, batches, val_batches, nb_steps, nb_epoch=1):
        """
            Fits the model on data yielded batch-by-batch by a Python generator.
            See Keras documentation: https://keras.io/models/model/
        """
        self.model.fit_generator(batches, steps_per_epoch=nb_steps, epochs=nb_epoch)
